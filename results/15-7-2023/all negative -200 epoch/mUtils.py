...
# Create model 
    def creat__new_model(self):
        ...
        self.X_train_part,self.X_test_part,self.y_train_part,self.y_test_part = train_test_split(self.X_train,self.y,test_size=0.2,shuffle=True)
        
        """ 
        self.X_train_part = self.X_train
        self.X_test_part = self.X_train
        self.y_train_part = self.y
        self.y_test_part = self.y
        """



        self.model.fit(self.X_train_part, self.y_train_part, epochs=self.myepochs, 
...
# Evalute the model
    ...
    def evaluate_model(self):
        ...
        self.score = self.model.evaluate(self.X_test_part, self.y_test_part)
